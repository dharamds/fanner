...
open class SwiftHSVColorPicker: UIView, ColorWheelDelegate, BrightnessViewDelegate {
    ...
    func setup() {
        ...
        selectedColorView = SelectedColorView(frame: CGRect(x: centeredX, y:10, width: colorWheelSize, height: selectedColorViewHeight), color: self.color)
        ...
        brightnessView = BrightnessView(frame: CGRect(x: centeredX, y: colorWheel.frame.maxY-15, width: colorWheelSize, height: brightnessViewHeight), color: self.color)
