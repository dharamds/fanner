...
public class GoogleConnect: NSObject  {
    ...
    fileprivate struct Auth {
        static let Scope: NSString = "https://www.googleapis.com/auth/youtube.force-ssl"
    }
...
//            let familyName = user.profile.familyName
            ...
            let user = GoogleUser(userId: userId!, idToken: idToken!, fullName: fullName!, givenName: givenName!, email: email!)// familyName: familyName, 
