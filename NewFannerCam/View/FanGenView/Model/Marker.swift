...
enum MarkerType: String {
    ...
    case collectiveSport        = "collective Sport"
    case collectiveSportDetails        = "collective Sport Details"
    ...
    var actionImage : ActionImage {
        ...
        case .collectiveSport:
            return ActionImage.collectiveSport
        case .collectiveSportDetails:
            return ActionImage.collectiveSportDetails
        }
    }
    
    static var defaultCollectiveSport: [String] {
           return ["SOCCER", "FUTSAL", "BASKET", "WATER POLO", "RUGBY"]
       }
}
